...
.setColor(AloneDogru)
  .setTitle("GYMKHΛИΛ MØD ® | Durdur")
.setDescription(`<a:hypesquad1:750076071721828452>  | Müzikler ${message.author} tarafından durduruldu! GYMKHΛИΛ MØD ® ses kanalından ayrılıyor.`) 
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
